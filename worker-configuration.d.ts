/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3a24cc3de885eb01fa49fa76233e57ff)
...
declare namespace Cloudflare {
	...
	interface Env {
		SIMILIARITY_THRESHOLD: 0.92;
		AI_GATEWAY_NAME: "shell-ask";
		...
		GOOGLE_WORKSPACE_TARGET_USER: string;
		GMAIL_IMPERSONATE_USER: string;
